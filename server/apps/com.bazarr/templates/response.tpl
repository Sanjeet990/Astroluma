    ...
    <table class="w-1/2 mr-4 flex-1">
        <tbody>
            <tr>
                ...
                <td class="text-right w-1/2 text-itemCardText pb-2 text-xxs">{{episodes}}</td>
            </tr>
            <tr>
                <td class="text-left w-1/2 text-itemCardText pb-2 text-xxs flex items-center">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <td class="text-right w-1/2 text-itemCardText pb-2 text-xxs">{{providers}}</td>
            </tr>
        </tbody>
    </table>
    <table class="w-1/2 flex-1">
        <tbody>
            <tr>
                ...
                <td class="text-right w-1/2 text-itemCardText pb-2 text-xxs">{{movies}}</td>
            </tr>
            <tr>
                <td class="text-left w-1/2 text-itemCardText pb-2 text-xxs flex items-center">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <td class="text-right w-1/2 text-itemCardText pb-2 text-xxs">{{announcements}}</td>
            </tr>
        </tbody>
    </table>
</div>