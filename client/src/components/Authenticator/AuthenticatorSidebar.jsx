    ...
    return (
        <ClickOutside onClick={() => closeAuthenticator()} className="relative">
            <motion.div
                ...
                className="fixed right-0 top-0 bottom-0 w-80 bg-authPanelBg text-authPanelText shadow-lg z-99999"
            >
                <div className="">
                    ...
                    {
                        <div className="overflow-y-auto overflow-x-hidden p-4 " style={{ maxHeight: 'calc(100vh - 70px)' }}>
                            <AnimatePresence>
                                {!selectedService && (
                                    <motion.ul
                                        initial={{ opacity: 0 }}
