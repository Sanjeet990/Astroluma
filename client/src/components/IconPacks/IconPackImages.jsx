...
import { contentLoadingState, loginState, deleteImageModalState, deletedImageState } from '../../atoms';
    ...
    return (
        <>
            ...
            <div className="mt-4">
                <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-4">
                    {imageList.map((image) => (
                        <motion.div
                            ...
                            className="relative w-full aspect-square p-2 border border-imageSelectionBorder hover:border-imageSelectionHoverBorder bg-imageSelectionBg hover:bg-imageSelectionHoverBg rounded-lg flex justify-center items-center transition-all duration-300 group"
                        >
                            <ImageView
                                src={image.iconPath}
                                alt={`Image ${image.id}`}
                ...
                {(!isDataLoading && imageList.length > 0 && hasMoreItems) && (
